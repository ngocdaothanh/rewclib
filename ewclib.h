...
// OS:Windows XP
// Compiler:Visual C++ 2005 Professional
//           + Platform SDK (DirectShow) + DirectX SDK
...
#pragma warning(disable:4996)	//strsafe.hに関する警告対策
#pragma warning(disable:4819)	//uuids.hに関する警告対策
...
cont:
	...
	//COM初期化
	ewc_hr= CoInitialize(0);
	if(ewc_hr!=S_OK){errcode=2; goto fin;}
